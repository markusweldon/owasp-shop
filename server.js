...
const aiProductAssistant = require('./routes/aiProductAssistant')
...
app.post('/rest/chatbot/ai-assistant', aiProductAssistant())
app.get('/rest/admin/log-search', logSearch())
/* NoSQL API endpoints */
